    ...
    <div class="sidebar">
        <el-menu :default-active="onRoutes" class="el-menu-vertical-demo"  unique-opened router>
            ...
            <el-submenu index="2">
                ...
                <el-menu-item index="eltable">element表格组件</el-menu-item>
            </el-submenu>
            <el-submenu index="3">
                <template slot="title"><i class="el-icon-date"></i>表单</template>
                <el-menu-item index="baseform">基本表单</el-menu-item>
                <el-menu-item index="dynamicvalidateform">动态增减表单项</el-menu-item>
            ...
            <el-submenu index="5">
                <template slot="title"><i class="el-icon-star-on"></i>树状</template>
                <el-menu-item index="trees">tree树</el-menu-item>
            </el-submenu>
        </el-menu>
    </div>
</template>
